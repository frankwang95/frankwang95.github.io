...
Given a constant auto-regressive prior, a larger value from the computed expression above indicates that character $$i$$ in $$s$$ is more likely to be a part of a positive segment.
